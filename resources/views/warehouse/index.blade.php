                            ...
                            <tbody>
                                @forelse ($almacenes as $almacen)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{$almacen->id}}"><i class="bi bi-pencil"></i></button>
                                            @if ($almacen->status == true)
                                    ...
                                    <div class="modal fade" id="exampleModal{{$almacen->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form action="{{route('almacen.update',$almacen)}}" method="POST">
                                                    @csrf @method('PATCH')
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Editar almacén #{{$almacen->id}}</h5>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($inventarios as $inventario)
                                    ...
                                    <div class="modal fade" id="addInventario{{$inventario->id}}" tabindex="-1" aria-labelledby="addInventario{{$inventario->id}}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <input type="number" class="form-control" step="any" required readonly value="{{$inventario->price}}" id="price{{$inventario->id}}">
                                                            </div>
                                                            <div class="col">
                                                                <label for="">Cantidad</label>
                                                                <input name="quantity" type="number" class="form-control cantidad" required data-id="{{$inventario->id}}" min="1" max="{{$inventario->stock}}" value="1">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="">Sub Total</label>
                                                                <input type="number" class="form-control" step="any" id="subtotal{{$inventario->id}}" value="{{$inventario->price}}" readonly name="subtotal">
                                                            </div>
                                                            <div class="col">
                                                                <label for="">Descuento en %</label>
                                                                <input name="discount" type="number" data-id="{{$inventario->id}}" class="form-control descuento" step="any" id="descuento{{$inventario->id}}" value="0" min="0">
                                                            </div>
                                                            <div class="col">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="container">
                                <div class="row">
                                        ...
                                        <select name="office_id" id="" class="form-control" required>
                                            ...
                                            @forelse ($oficinas as $oficina)
                                                @if ($oficina->id == Auth::user()->branch_office_id)
                                                    <option selected value="{{$oficina->id}}">{{$oficina->name}}</option>
                                                @else
                                    ...
                                    <div class="col">
                                        <label for="">Sub Total</label>
                                        <input type="number" name="subtotal" class="form-control" step="any" id="subtotalGeneral" readonly value="{{$total}}">
                                    </div>
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <label for="">Total</label>
                                        <input type="number" name="total" class="form-control" step="any" id="totalGeneral" readonly value="{{$total}}">
                                    </div>
                                </div>
                            </div>
                        </div>
